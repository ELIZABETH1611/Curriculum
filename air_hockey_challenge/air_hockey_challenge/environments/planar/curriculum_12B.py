...
class AirHockeyCurriculum(AirHockeySingle):
    ...
    def is_absorbing(self, obs):
        ...
        delta_x = ee_pos[0] - puck_pos[0]
        delta_y = ee_pos[1] - puck_pos[1]

        # Calcula la magnitud de ΔA
        magnitud_delta = math.sqrt(delta_x**2 + delta_y**2)

        # Calcula el ángulo en radianes usando arccos
        self.puck_theta = math.acos(delta_x / magnitud_delta)
