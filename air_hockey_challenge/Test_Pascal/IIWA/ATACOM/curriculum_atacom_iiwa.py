...
from constraints_iiwa import *
# from air_hockey_challenge.constraints.constraints_iiwa import *
...
class AirHockeyCurriculumPosition(PositionControlIIWA, AirHockeyCurriculum):
    pass
